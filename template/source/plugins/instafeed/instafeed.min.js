...
!function (e, t) {
  ...
  function e(e, t) {
    ...
    var t = "function" == typeof this._options.transform,
        ...
        a = null,
        u = null,
        c = null;if (this._debug("processData", "hasFilter", o, "hasTransform", t, "hasSort", n, "hasLimit", r), "object" != (typeof e === "undefined" ? "undefined" : _typeof(e)) || "object" != _typeof(e.data) || e.data.length <= 0) return null;for (var l = 0; l < e.data.length; l++) {
    ...
    var t = /#([^\s]+)/gi,
        o = /[~`!@#$%^&*\(\)\-\+={}\[\]:;"'<>\?,\.\/|\\\s]+/i,
        n = [];if ("string" == typeof e) for (; null !== (match = t.exec(e));) {
    ...
    var t = "string" == typeof this._options.template,
        ...
        n = null,
        r = null,
        s = "";if (this._debug("renderData", "hasTemplate", t, "hasRender", o), "object" != (typeof e === "undefined" ? "undefined" : _typeof(e)) || e.length <= 0) return null;for (var i = 0; i < e.length; i++) {
      if (n = e[i], o) try {
      ...
      } else t && (r = this._basicRender(n));r ? s += r : this._debug("renderData", "render item did not return any content", n);
    }return s;
    ...
    for (var o = /([\w]+)/gm, n = null, r = t; null !== (n = o.exec(e));) {
      if ("object" != (typeof r === "undefined" ? "undefined" : _typeof(r))) return null;r = r[n[1]];
    }return r;
    ...
    var o = !1,
      ...
      var t = r.getResponseHeader("Content-Type"),
          o = null;if (n._debug("apiRequestOnLoad", "loaded", e), n._debug("apiRequestOnLoad", "response status", r.status), n._debug("apiRequestOnLoad", "response content type", t), t.indexOf("application/json") >= 0) try {
    ...
    } else this._debug("getAccessToken", "treating accessToken as static", _typeof(this._options.accessToken)), r(null, this._options.accessToken);
